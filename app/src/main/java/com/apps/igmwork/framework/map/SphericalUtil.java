...
import static com.apps.igmwork.framework.map.MathUtil.EARTH_RADIUS;
import static com.apps.igmwork.framework.map.MathUtil.arcHav;
import static com.apps.igmwork.framework.map.MathUtil.havDistance;
import static com.apps.igmwork.framework.map.MathUtil.wrap;
